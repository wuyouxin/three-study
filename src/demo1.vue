...
export default {
  created () {
    ...
    this.scene.background = new Color('rgba(20,40,70,0.2)')
    this.camera = new PerspectiveCamera(75, window.innerWidth / window.innerHeight, 0.1, 1000)
    // 添加烟雾
    this.scene.fog = new Fog(0xf7d9aa, 100, 950)
    // 添加坐标线
    this.axes = new AxisHelper(500)
    ...
    this.mesh = new Mesh(boxGeometry, meshBasicMaterial)
    this.mesh.name = 'box'
    this.light = new HemisphereLight(0xbbbbff, 0x444422, 1.2)
